<section
      ...
      >
        <img
          ...
          src="<?= base_url('assets/images/backgrounds/cta-1-bg-1.jpg'); ?>"
          alt="parallax-image"
        />
        <div class="container">
          <div class="row">
            <div class="col-lg-5 wow fadeInLeft" data-wow-duration="1500ms">
              <div class="call-to-action__three-image">
                <img src="<?= base_url('assets/images/resources/cta-3-1.jpg'); ?>" alt="" />
                <img src="<?= base_url('assets/images/resources/cta-3-2.jpg'); ?>" alt="" />
              </div>
